...
const VideoDone: React.FC = () => {
  return (
    <div className="flex flex-col items-start justify-between h-full px-6 md:px-0 md:min-h-0 md:pb-0 pb-10 min-h-screen">
      ...
      <div>
        <h1 className="text-2xl md:text-4xl font-bold text-gray-800">Seu vídeo está pronto!</h1>
      ...
      <p className="text-darkgreen mt-3 text-base font-medium underline">Criar um novo vídeo</p>
    </div>
  )
}
